...
Future<void> myRequest1() async // 게임으로 치면 좌판
{
...
Future<int> myRequest3(num)
{
  return Future(() {
    ...
    print('myRequest3(num) 작업끝'); // async는 위 작업이 끝나야 실행됨
    return rNum;
  });
}
...
void main() async{    // async를 제거하면 아래에서 에러 발생됨
  ...
  print('main 시작02');
  /*
    Future와 then절을 함께 사용하거나 (방법 1)
    async와 await을 사용해야 한다. (방법 2)
  */
...
// future then : 기다리지 않고 넘어가고 결과가 나중에 나온다
// async await : 기다리고 결과가 나와야 다음으로 넘어간다.