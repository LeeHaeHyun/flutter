void main()
{
  ...
  /*
      ...
      선언이다. Map은 이와같이 key와 value의 쌍으로 이루어진다.
  */
  Map<String, int> map2 = Map(); // new를 생략한 형태
  map2['홍길동'] = 20;
  map2['전우치'] = 25;
  map2['손오공'] = 30;
  print(map2);
  ...
  // Dart의 삼항연산자로 앞의 값이 null이면 뒤의 값이 할당됨.
  // 이래서 앞에 ?가 없음(null safety)
  int val2 = map2['홍길동'] ?? -1;
  print(val2);
  ...
  print(val3);
  // val3='마임';  val3은 정수형 변수로 되어 다른 타입이 들어오면 에러

  // 해당 map이 해당 key값을 가지고 있는지 점검
  // 이렇게 하면 null 체크를 할 필요가 없음
