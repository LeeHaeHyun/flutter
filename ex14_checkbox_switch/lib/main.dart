        ...
        child: Column( // 세로형 배치
          ...
          children: <Widget>[
              ...
              Checkbox(
                ...
                // 체크 or 언체크시 이벤트 처리
                // 위에서 bool을 ? 안했기 때문에 이곳에서는 bool? 쓴다.
                onChanged: (bool? value) {      // 이벤트 체크
                // 매개변수를 Nullable로 지정
                  setState(() {   // 변경 후 UI를 다시 그린다.
                  /*
                    null check operator 
                      : 변수 뒤에 !를 추가하면 이 변수값이 null인 경우 runtime error가 발생한다
                  */
                    _chk1 = value!;
                  });
               ...
               Checkbox(
                value: _chk2,
                checkColor: Colors.pink, // 체크되었을때 마크의 색
              ...
              Switch(
                ...
                inactiveTrackColor: Colors.lightGreenAccent,  // 체크 안했을때 배경색
