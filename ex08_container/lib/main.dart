        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            // 저장한 방향에만 적용한다.
              ...
              // width: 300, // 크기를 지정하지 않으면 부모의 크기(휴대폰 디스플레이 크기(부모))
              height: 100,    // 크기를 지정하지 않으면 자식의 크기(무한정 길어질 수 있다(스크롤))
              alignment: Alignment.topLeft,
              child: const Text(  // text를 감싼다.
                '홍길동',
