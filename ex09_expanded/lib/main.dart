        ...
        child: Column(
          ...
          children: <Widget>[
            Expanded(
              ...
              child: Container(
                margin: const EdgeInsets.all(0.0), // 마진(밖)
                padding: const EdgeInsets.all(0.0), // 패딩(안)
                ...
                child: Image.asset(
                  ...
                  // width: 390.0,  // 크기를 지정하지 않으면 부모의 크기
                  // height: 250.0, // 크기를 지정하지 않으면 자식의 크기
                  ),
                ),
              ),
              Container(
...
void _onClick1() {
  /*
    ...
    화면의 렌더링이 다시 진행된다. 변경된 화면을 볼 수 있게 된다.
  */
  setState(() {
