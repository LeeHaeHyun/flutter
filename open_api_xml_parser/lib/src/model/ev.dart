class Ev {
  ...
  factory Ev.fromJson(Map<String, dynamic> json) {
    ...
    // 충전 방식 
    if (json["cpTp"] == "1") {
      json["cpTp"] = "충전방식 : B타입(5핀)";
    } else if (json["cpTp"] == "2") {
      json["cpTp"] = "충전방식 : C타입(5핀)";
    } else if (json["cpTp"] == "3") {      
      json["cpTp"] = "충전방식 : BC타입(5핀)";
    } else if (json["cpTp"] == "4") {         
      json["cpTp"] = "충전방식 : BC타입(7핀)";
    } else if (json["cpTp"] == "5") {        
      json["cpTp"] = "충전방식 : DC차데모";
    } else if (json["cpTp"] == "6") {    
      json["cpTp"] = "충전방식 : AC3상";
    } else if (json["cpTp"] == "7") {  
      json["cpTp"] = "충전방식 : DC콤보";
    } else if (json["cpTp"] == "8") { 
      json["cpTp"] = "충전방식 : DC차데모+DC콤보";
    } else if (json["cpTp"] == "9") { 
      json["cpTp"] = "충전방식 : DC차데모+AC3상";     
    } else if (json["cpTp"] == "10") {
      json["cpTp"] = "충전방식 : DC차데모+DC콤보+AC3상";      
    }
